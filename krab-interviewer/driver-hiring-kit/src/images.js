...
export const IMAGES = {
  ...
  stepsApply: "/images/steps-interview.jpg",
  /** Step 2 — Get the papers (USPS delivery) */
  stepsPackage: "/images/steps-get-papers.jpg",
  /** Step 3 — Start your first delivery (earning) */
  stepsDrive: "/images/steps-first-delivery.jpg",
};
